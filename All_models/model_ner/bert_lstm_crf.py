...
from All_models.model_ner.crf import CRF
...
class BERT_LSTM_CRF(nn.Module):
    def __init__(self, bert_config, tagset_size, embedding_dim, hidden_dim, rnn_layers, dropout_ratio, dropout1,
        ...
        # edit by cpc
        self.word_embeds = BertModel.from_pretrained(bert_config, return_dict=False)  # 将文本映射为词向量 -> 类别
        # 预处理， 只是将文本转为高维向量,
        ...
        self.liner = nn.Linear(hidden_dim, tagset_size + 2)  # 1+ 118 +1    [ 0, 0 ,0 ,0 ,0 ,0 ,0 ,4, 5, 0,0,0,0]
